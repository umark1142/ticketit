...
@section('footer')
	<script src="https://cdn.datatables.net/v/bs4/dt-{{ Umark\Ticketit\Helpers\Cdn::DataTables }}/r-{{ Umark\Ticketit\Helpers\Cdn::DataTablesResponsive }}/datatables.min.js"></script>
	<script>
	    $('.table').DataTable({
	        processing: false,
	        serverSide: true,
