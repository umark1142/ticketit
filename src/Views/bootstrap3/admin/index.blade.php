                        ...
                        <div class="pull-right">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-right" role="menu">
                                    <li>
                                        <a href="{{ action('\Umark\Ticketit\Controllers\DashboardController@index', 2) }}">
                                            {{ trans('ticketit::admin.index-3-months') }}
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ action('\Umark\Ticketit\Controllers\DashboardController@index', 5) }}">
                                            {{ trans('ticketit::admin.index-6-months') }}
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ action('\Umark\Ticketit\Controllers\DashboardController@index', 11) }}">
