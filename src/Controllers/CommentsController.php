...
class CommentsController extends Controller
{
    ...
    {
        $this->middleware('Umark\Ticketit\Middleware\IsAdminMiddleware', ['only' => ['edit', 'update', 'destroy']]);
        $this->middleware('Umark\Ticketit\Middleware\ResAccessMiddleware', ['only' => 'store']);
    }
