...
Route::group(['middleware' => \Umark\Ticketit\Helpers\LaravelVersion::authMiddleware()], function () use ($main_route, $main_route_path, $admin_route, $admin_route_path) {

    //Route::group(['middleware' => '', function () use ($main_route) {
    //Ticket public route
    Route::get("$main_route_path/complete", 'Umark\Ticketit\Controllers\TicketsController@indexComplete')
            ->name("$main_route-complete");
    Route::get("$main_route_path/data/{id?}", 'Umark\Ticketit\Controllers\TicketsController@data')
            ->name("$main_route.data");

    $field_name = last(explode('/', $main_route_path));
    Route::resource($main_route_path, 'Umark\Ticketit\Controllers\TicketsController', [
            'names' => [
    ...
    Route::resource("$main_route_path-comment", 'Umark\Ticketit\Controllers\CommentsController', [
            'names' => [
    ...
    Route::get("$main_route_path/{id}/complete", 'Umark\Ticketit\Controllers\TicketsController@complete')
            ->name("$main_route.complete");

    //Ticket reopen route for permitted user.
    Route::get("$main_route_path/{id}/reopen", 'Umark\Ticketit\Controllers\TicketsController@reopen')
            ->name("$main_route.reopen");
    //});

    Route::group(['middleware' => 'Umark\Ticketit\Middleware\IsAgentMiddleware'], function () use ($main_route, $main_route_path) {
        ...
        Route::get("$main_route_path/agents/list/{category_id?}/{ticket_id?}", [
            ...
            'uses' => 'Umark\Ticketit\Controllers\TicketsController@agentSelectList',
        ]);
    });

    Route::group(['middleware' => 'Umark\Ticketit\Middleware\IsAdminMiddleware'], function () use ($admin_route, $admin_route_path) {
        ...
        Route::get("$admin_route_path/indicator/{indicator_period?}", [
                ...
                'uses' => 'Umark\Ticketit\Controllers\DashboardController@index',
        ]);
        Route::get($admin_route_path, 'Umark\Ticketit\Controllers\DashboardController@index');

        //Ticket statuses admin routes (ex. http://url/tickets-admin/status)
        Route::resource("$admin_route_path/status", 'Umark\Ticketit\Controllers\StatusesController', [
            'names' => [
        ...
        Route::resource("$admin_route_path/priority", 'Umark\Ticketit\Controllers\PrioritiesController', [
            'names' => [
        ...
        Route::resource("$admin_route_path/agent", 'Umark\Ticketit\Controllers\AgentsController', [
            'names' => [
        ...
        //Agents management routes (ex. http://url/tickets-admin/agent)
        Route::resource("$admin_route_path/category", 'Umark\Ticketit\Controllers\CategoriesController', [
            'names' => [
        ...
        Route::resource("$admin_route_path/configuration", 'Umark\Ticketit\Controllers\ConfigurationsController', [
            'names' => [
        ...
        Route::resource("$admin_route_path/administrator", 'Umark\Ticketit\Controllers\AdministratorsController', [
            'names' => [
        ...
        // Route::get("$admin_route/demo-seeds", 'Umark\Ticketit\Controllers\InstallController@demoDataSeeder');
    });
});
